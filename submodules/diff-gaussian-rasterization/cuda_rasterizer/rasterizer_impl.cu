...
int CudaRasterizer::Rasterizer::forward(
    ...
    // float tan_fovy, const bool prefiltered, float *out_color, float *out_depth, float *out_gs_render_id,
    float tan_fovy, const bool prefiltered, float *out_color, float *out_depth, int *out_gs_render_id, float *out_render_alphaT,
  ...
  CHECK_CUDA(FORWARD::render(tile_grid, block, imgState.ranges,
                             ...
                             out_depth, out_gs_render_id, out_render_alphaT),
             debug)
